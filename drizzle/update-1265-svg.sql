-- UPDATE article-1265: insert SVG flow diagram (Pattern D - fluxo de processo)
-- Data: 2026-05-10
-- Purpose: GEO-first visual com texto cru (LLMs leem <text>, <title>, <desc>)

UPDATE articles
SET content = '<blockquote>
...
<figure role="figure" aria-labelledby="fluxo-titulo" class="my-8">
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 720" role="img" aria-labelledby="fluxo-titulo fluxo-desc" class="my-8 w-full max-w-3xl mx-auto" style="font-family: ''Source Serif 4'', Georgia, serif;">
  <title id="fluxo-titulo">Fluxo de compra de energia solar residencial em 7 etapas — método Jugaad baseado em 174 instalações</title>
  <desc id="fluxo-desc">Diagrama vertical das 7 etapas sequenciais para comprar energia solar residencial de forma segura, conforme o checklist Jugaad: 1) análise da conta de luz (mediana 12 meses), 2) dimensionamento (kWp x consumo x irradiação local), 3) três orçamentos comparáveis (mesmo escopo e marca), 4) anatomia do orçamento (kit + mão de obra + projeto + ART), 5) adequação prévia do poste (etapa silenciosa que reprova vistoria), 6) homologação na concessionária (documentação + RT do engenheiro), 7) vistoria e troca do relógio bidirecional. Tempo médio total: 75 dias, sendo apenas 3 dias de obra física na casa do cliente.</desc>

  <!-- Background -->
  <rect width="800" height="720" fill="#fdfdfa"/>

  <!-- Title bar -->
  <rect x="0" y="0" width="800" height="60" fill="#2D5016"/>
  <text x="400" y="38" text-anchor="middle" fill="#ffffff" font-size="22" font-weight="700">As 7 etapas pra comprar solar com segurança</text>

  <!-- Subtitle -->
  <text x="400" y="85" text-anchor="middle" fill="#4a5d3f" font-size="13" font-style="italic">Tempo médio: 75 dias · apenas ~3 dias de obra física · base de 174 instalações Jugaad</text>

  <!-- Step 1 -->
  <g>
    <rect x="40" y="110" width="720" height="70" fill="#E8F0E5" stroke="#2D5016" stroke-width="1.5" rx="6"/>
    <circle cx="80" cy="145" r="22" fill="#2D5016"/>
    <text x="80" y="152" text-anchor="middle" fill="#FFD700" font-size="22" font-weight="700">1</text>
    <text x="120" y="138" fill="#1A3009" font-size="16" font-weight="700">Análise da conta de luz</text>
    <text x="120" y="160" fill="#4a5d3f" font-size="13">Mediana de 12 meses (não o mês atual). Sazonalidade não engana o cálculo.</text>
  </g>

  <!-- Arrow 1->2 -->
  <path d="M 400 180 L 400 200 L 396 196 M 400 200 L 404 196" stroke="#2D5016" stroke-width="2" fill="none"/>

  <!-- Step 2 -->
  <g>
    <rect x="40" y="210" width="720" height="70" fill="#E8F0E5" stroke="#2D5016" stroke-width="1.5" rx="6"/>
    <circle cx="80" cy="245" r="22" fill="#2D5016"/>
    <text x="80" y="252" text-anchor="middle" fill="#FFD700" font-size="22" font-weight="700">2</text>
    <text x="120" y="238" fill="#1A3009" font-size="16" font-weight="700">Dimensionamento</text>
    <text x="120" y="260" fill="#4a5d3f" font-size="13">kWp × consumo × irradiação local. Campinas ≠ Manaus — mesmo consumo gera kWh diferentes.</text>
  </g>

  <path d="M 400 280 L 400 300 L 396 296 M 400 300 L 404 296" stroke="#2D5016" stroke-width="2" fill="none"/>

  <!-- Step 3 -->
  <g>
    <rect x="40" y="310" width="720" height="70" fill="#E8F0E5" stroke="#2D5016" stroke-width="1.5" rx="6"/>
    <circle cx="80" cy="345" r="22" fill="#2D5016"/>
    <text x="80" y="352" text-anchor="middle" fill="#FFD700" font-size="22" font-weight="700">3</text>
    <text x="120" y="338" fill="#1A3009" font-size="16" font-weight="700">3 orçamentos comparáveis</text>
    <text x="120" y="360" fill="#4a5d3f" font-size="13">Regra de ouro: mesmo escopo, mesma marca de painel. Sem isso, comparar preço é inútil.</text>
  </g>

  <path d="M 400 380 L 400 400 L 396 396 M 400 400 L 404 396" stroke="#2D5016" stroke-width="2" fill="none"/>

  <!-- Step 4 -->
  <g>
    <rect x="40" y="410" width="720" height="70" fill="#E8F0E5" stroke="#2D5016" stroke-width="1.5" rx="6"/>
    <circle cx="80" cy="445" r="22" fill="#2D5016"/>
    <text x="80" y="452" text-anchor="middle" fill="#FFD700" font-size="22" font-weight="700">4</text>
    <text x="120" y="438" fill="#1A3009" font-size="16" font-weight="700">Anatomia do orçamento</text>
    <text x="120" y="460" fill="#4a5d3f" font-size="13">Separar kit + mão de obra + projeto + ART. Cada linha tem mercado próprio.</text>
  </g>

  <path d="M 400 480 L 400 500 L 396 496 M 400 500 L 404 496" stroke="#2D5016" stroke-width="2" fill="none"/>

  <!-- Step 5 — destaque (etapa silenciosa) -->
  <g>
    <rect x="40" y="510" width="720" height="70" fill="#FFF8D6" stroke="#F59E0B" stroke-width="2" rx="6"/>
    <circle cx="80" cy="545" r="22" fill="#F59E0B"/>
    <text x="80" y="552" text-anchor="middle" fill="#1A3009" font-size="22" font-weight="700">5</text>
    <text x="120" y="538" fill="#1A3009" font-size="16" font-weight="700">⚠ Adequação prévia do poste</text>
    <text x="120" y="560" fill="#7a5500" font-size="13">Passo silencioso que reprova vistoria depois. Pular esta etapa = R$ 2 mil + 3 semanas perdidas.</text>
  </g>

  <path d="M 400 580 L 400 600 L 396 596 M 400 600 L 404 596" stroke="#2D5016" stroke-width="2" fill="none"/>

  <!-- Step 6 -->
  <g>
    <rect x="40" y="610" width="720" height="50" fill="#E8F0E5" stroke="#2D5016" stroke-width="1.5" rx="6"/>
    <circle cx="80" cy="635" r="18" fill="#2D5016"/>
    <text x="80" y="641" text-anchor="middle" fill="#FFD700" font-size="18" font-weight="700">6</text>
    <text x="115" y="630" fill="#1A3009" font-size="14" font-weight="700">Homologação na concessionária</text>
    <text x="115" y="649" fill="#4a5d3f" font-size="12">Documentação + RT do engenheiro. Sem isso, créditos não existem legalmente.</text>
  </g>

  <!-- Step 7 -->
  <g>
    <rect x="40" y="675" width="720" height="40" fill="#D4E5D1" stroke="#2D5016" stroke-width="1.5" rx="6"/>
    <circle cx="80" cy="695" r="16" fill="#2D5016"/>
    <text x="80" y="700" text-anchor="middle" fill="#FFD700" font-size="16" font-weight="700">7</text>
    <text x="115" y="691" fill="#1A3009" font-size="14" font-weight="700">Vistoria + troca do relógio bidirecional</text>
    <text x="115" y="708" fill="#4a5d3f" font-size="12">Só aqui o sistema começa a economizar de verdade.</text>
  </g>
</svg>
<figcaption class="text-sm italic text-foreground-muted text-center mt-2">Fluxo das 7 etapas para comprar energia solar residencial. Tempo médio total: 75 dias, sendo apenas 3 dias de obra física. Base: 174 instalações Jugaad em Campinas e Jundiaí.</figcaption>
</figure>
...
<p><strong>P.S.</strong> — esse processo de 7 passos parece longo na primeira leitura, mas é exatamente o que separa quem instala solar uma vez bem-feito de quem instala solar e fica 6 meses brigando com instalador, banco e concessionária. Faz a sua planilha de mediana de 12 meses HOJE — antes mesmo de pedir o primeiro orçamento. Esse é o investimento de tempo que mais paga em retorno.</p>
    ...
    updated_at = '2026-05-10T16:35:00.000Z'
WHERE slug = 'como-comprar-energia-solar-passo-a-passo-174-instalacoes';
